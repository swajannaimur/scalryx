...
export function Logo({ compact = false, className = "" }: LogoProps) {
  return (
    ...
    >
      <span aria-hidden="true" className="relative block size-5 text-[var(--brand-navy)]">
        <span className="absolute left-[9px] top-0 h-5 w-[3px] rotate-45 rounded-full bg-current" />
