...
export function BusinessTypeStep({
  ...
  return (
    <div className="rounded-2xl border border-line bg-surface-raised p-5 shadow-[0_20px_50px_var(--shadow)] sm:p-6">
      <p className="text-sm font-semibold text-blue-500">Step 1 of 2</p>
      <fieldset className="mt-3">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          {businessChoices.map((choice) => {
            ...
            return (
              <label
                className={`group flex min-h-28 cursor-pointer items-center gap-3 rounded-xl border p-3.5 transition ${
                  selected
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-blue-500/15 text-xs font-bold text-blue-500"
                >
                  {choice.initials}
                </span>
                ...
                <span
                  aria-hidden="true"
                  className="text-lg text-subtle transition group-hover:translate-x-0.5 group-hover:text-blue-500"
                >
                  →
                </span>
              </label>
